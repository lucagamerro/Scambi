...
$query = "DELETE FROM annunci WHERE titolo='$titolo'";
...
<br>
  ...
  <h4 class="alert-heading">Annuncio eliminato</h4>
  <p class="mb-0">Annuncio eliminato dalla lista. Vai alla <a href="/home.php?pw=rivoli" class="alert-link">lista</a>.</p>
</div>
<br>
<br>
<br>
